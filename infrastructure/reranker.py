...
class RerankerClient:
    ...
    def score_batch(self, pairs: List[Tuple[str, str]], instruction: Optional[str] = None, batch_size: int = 8) -> List[float]:  # Signature düzeltildi
        texts = [self._format(q, d, instruction) for q, d in pairs]  # pairs üzerinden iterasyon
        results: List[float] = []
